...
public class ProfitCalculatorTest {
	...
	public void test0() {
		...
		assertEquals(32, new ProfitCalculator().percent(items));
	}
	
	@Test
	public void test1() {
		String[] items = new String[] {"000.00 049.99","999.99 936.22","033.99 025.64","249.99 211.87"};
		assertEquals(4, new ProfitCalculator().percent(items));
	}
	
	@Test
	public void test2() {
		String[] items = new String[] {"822.77 704.86","829.42 355.45","887.18 949.38"};
		assertEquals(20, new ProfitCalculator().percent(items));
	}
	
	@Test
	public void test3() {
		String[] items = new String[] {"612.72 941.34","576.46 182.66","787.41 524.70","637.96 333.23","345.01 219.69",
 "567.22 104.77","673.02 885.77"};
		assertEquals(23, new ProfitCalculator().percent(items));
	}
	
	@Test
	public void test4() {
		String[] items = new String[] {"811.22 275.32","433.89 006.48","141.28 967.41","344.47 786.23","897.47 860.61",
 ...
 "304.76 015.91","460.63 636.56","357.84 436.20","752.24 047.64","922.10 573.12"};
		assertEquals(10, new ProfitCalculator().percent(items));
	}
}
